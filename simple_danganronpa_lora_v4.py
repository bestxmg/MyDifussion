#!/usr/bin/env python3
"""
Danganronpa LoRA Training Script - Local Models Version
Works with locally cached models to avoid network issues
"""
...
# Setup logging without Unicode symbols to avoid encoding issues
logging.basicConfig(
    level=logging.INFO,
...
def load_local_models():
    ...
    try:
        ...
        logger.info("Models may not be cached locally. Please run your GUI first to download them.")
...
def train_simple_lora(
    ...
    # Load models from local cache
    tokenizer, text_encoder, unet, vae = load_local_models()
    ...
    if device == "cpu":
        logger.warning("Training on CPU will be very slow! Consider using CUDA.")
    ...
    try:
        ...
        logger.info("All models loaded and configured successfully")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Danganronpa LoRA Training - Local Models")
    ...
    if args.train:
        ...
        print("Example:")
        print("  python simple_danganronpa_lora_v4.py --train")
        print("  python simple_danganronpa_lora_v4.py --test")
